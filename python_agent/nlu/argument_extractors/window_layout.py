...
from python_agent.nlu.argument_extractors.window_layout_model import WindowLayoutModelExtractor


class WindowLayoutExtractor(ArgumentExtractor):
    def __init__(
        self,
        model_path: str | Path | None = None,
        model_extractor: ArgumentExtractor | None = None,
    ) -> None:
        self.model_extractor = model_extractor or WindowLayoutModelExtractor(model_path=model_path)
